...
public class TweetNaclFastInstanced {
  private void coreSalsa20(byte[] o, byte[] p, byte[] k) {
    int j0 = sigma[0] & 0xff | (sigma[1] & 0xff) << 8 | (sigma[2] & 0xff) << 16 | (sigma[3] & 0xff) << 24,
      ...
      j5 = sigma[4] & 0xff | (sigma[5] & 0xff) << 8 | (sigma[6] & 0xff) << 16 | (sigma[7] & 0xff) << 24,
      j6 = p[0] & 0xff | (p[1] & 0xff) << 8 | (p[2] & 0xff) << 16 | (p[3] & 0xff) << 24,
      j7 = p[4] & 0xff | (p[5] & 0xff) << 8 | (p[6] & 0xff) << 16 | (p[7] & 0xff) << 24,
      j8 = p[8] & 0xff | (p[9] & 0xff) << 8 | (p[10] & 0xff) << 16 | (p[11] & 0xff) << 24,
      j9 = p[12] & 0xff | (p[13] & 0xff) << 8 | (p[14] & 0xff) << 16 | (p[15] & 0xff) << 24,
      j10 = sigma[8] & 0xff | (sigma[9] & 0xff) << 8 | (sigma[10] & 0xff) << 16 | (sigma[11] & 0xff) << 24,
      j11 = k[16] & 0xff | (k[17] & 0xff) << 8 | (k[18] & 0xff) << 16 | (k[19] & 0xff) << 24,
      j12 = k[20] & 0xff | (k[21] & 0xff) << 8 | (k[22] & 0xff) << 16 | (k[23] & 0xff) << 24,
      j13 = k[24] & 0xff | (k[25] & 0xff) << 8 | (k[26] & 0xff) << 16 | (k[27] & 0xff) << 24,
      j14 = k[28] & 0xff | (k[29] & 0xff) << 8 | (k[30] & 0xff) << 16 | (k[31] & 0xff) << 24,
      j15 = sigma[12] & 0xff | (sigma[13] & 0xff) << 8 | (sigma[14] & 0xff) << 16 | (sigma[15] & 0xff) << 24;
